...
const Header = () => {
  ...
  return (
    <div className="text-BlackHomz px-5 font-normal w-[147px] md:w-full md:flex justify-between text-[16px] max-w-[1160px] items-center  md:m-auto pt-12 shadow-m">
      ...
      <Link href={"/"}>
        <Image
          src="/static/images/Homz_Logo_Blue.png"
          alt="HOMZ"
          height={28}
      ...
      >
        <div className="mt-5 text-[12px] lg:text-[16px] md:mt-0 flex gap-4 md:gap-5 lg:gap-10  flex-col md:flex-row">
          ...
          <Link
            ...
            className={`hover:text-blue-400   ${
              pathname === "/landingPage-PropertyOwner" ? "text-BlueHomz" : ""
            }`}
          ...
          <Link
            ...
            // href={""}
            className={`hover:text-blue-400 ${
              pathname === "/landing-page-property" ? "text-BlueHomz" : ""
            }`}
            onClick={() => setOpen(false)}
          >
            Enterprise
          ...
          <Link
            ...
            // href={""}
            className={`hover:text-blue-400 ${
              pathname === "/landing-page-tenant" ? "text-BlueHomz" : ""
            }`}
            onClick={() => setOpen(false)}
          >
            Tenant
