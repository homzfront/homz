...
const Footer = () => {
  return (
    <div className="h-auto  md:max-w-[1440px] m-auto font-[400] text-[14px] px-4 md:px-8  sm:px-[140px] py-10 mt-0 md:mt-0 bg-black text-white">
      <div className=" md:items-center flex md:justify-center flex-col m-auto md:max-w-[1165px]">
        <div className="flex md:text-sm lg:w-full xl:w-[1165px] flex-col lg:flex-row md:items-center md:justify-center  lg:flex lg:items-start">
