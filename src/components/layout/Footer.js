        ...
        <div className="max-w-[338px] md:max-w-full lg:w-auto">
          ...
          <div className="md:mt-3 lg:mt-8 mt-8"> 
            <p className="mb-3 lg:max-w-[280px] ">
              Get weekly updates on the best deals on Properties & Developments
              in Nigeria.
            </p>
            <div className="flex flex-col max-w-full lg:flex-row  gap-2">
              <input type="text" placeholder="Email Address" className="border text-black font-semibold lg:w-[280px] h-8 text-[11.17px]  rounded-sm shadow-sm px-2 py-3" />
