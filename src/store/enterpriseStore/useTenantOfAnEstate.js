...
const useTenantOfAnEstate = create(
  persist(
    (set, get) => ({
      estateData: null,
      data: null,
    ...
    {
      name: 'tenant-estate-storage', // unique name for localStorage key
      storage: createJSONStorage(() => localStorage), // or sessionStorage
      partialize: (state) => ({ estateData: state.estateData }), // only persist estateData
    }
  )
);
