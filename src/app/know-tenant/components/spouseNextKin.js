        ...
        <div className='mt-4'>
            ...
            <div className='flex flex-col-reverse md:flex-row gap-2 md:gap-0 justify-center md:justify-between md:items-center mt-6 mb-[60px]'>
                ...
                <div className='flex items-center gap-4 md:gap-3 w-full md:w-auto'>
                    ...
                    <button onClick={() => setStep(2)} className={`${formData ? "border border-BlueHomz text-BlueHomz hover:bg-whiteblue" : "pointer-events-none bg-GrayHomz6 text-GrayHomz5"} p-3 rounded-[4px] hidden md:flex items-center gap-1`}>
                        Next {formData ? <ArrowRightSmall className='#006aff' /> : <ArrowRightSmall className='#d5d5d5' />}
                    </button>
                    <button onClick={() => setStep(2)} className={`${formData ? "bg-BlueHomz text-white hover:bg-blue-400" : "pointer-events-none bg-GrayHomz6 text-GrayHomz5"} w-[50%] p-3 rounded-[4px] flex md:hidden justify-center items-center gap-1`}>
