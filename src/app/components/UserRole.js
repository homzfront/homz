...
const UserRole = ({
  ...
  return (
    <div className={`${width ? width: ' '} w-[145px] adminCellBorder  rounded-[] hover:border-stone-500`}>
      ...
      <ul
        className={`dropdown-menu absolute  flex flex-col items-start py-2 gap-1 z-30 ${bg_color ? "bg_color": 'w-[146px] h-[200px] bg-white'} shadow-md rounded-md ring-1 ring-black ring-opacity-5 focus:outline-none ${
          isOpen ? "block" : "hidden"
        }`}
      >
        <li>
