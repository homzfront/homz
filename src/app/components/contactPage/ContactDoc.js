    ...
    <div className="flex w-full justify-center">
     <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-[1200px] w-full">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col max-w-[780px]">
             <label className="text-BlackHomz mt-4 text-[16px] font-[500] mb-1">What will you like to enquire about?</label>
            <input
              type="drop-down"
            ...
            />
            <label className="text-BlackHomz mt-4 text-[14px] font-[500] mb-1">Full Name</label>
            <input
              type="text"
            ...
            />
            <label className="text-BlackHomz mt-4 text-[14px] font-[500] mb-1">Email Address</label>
            <input
              type="email"
            ...
            />
            <label className="text-BlackHomz mt-4 text-[14px] font-[500] mb-1">Phone Number</label>
            <div className="ml-[-18px]">
            <PhoneInput
              type='number'
              placeholder="Phone Number"
              value={phoneNo}
              className="px-4 mr-[-10px] rounded-md"
              fullWidth="true"
              onChange={(e) => setPhoneNo(e.target.value)}
            />
            </div>
            <label className="text-BlackHomz mt-4 text-[14px] font-[500] mb-1">Your Message</label>
            <ReactQuill
              ...
              formats={formats}
            />
            <button className="bg-BlueHomz mt-4 text-white h-10 w-full rounded-md">
              Send Message
            </button>
          </form>
        </div>
