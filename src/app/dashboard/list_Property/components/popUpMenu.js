...
const PopUpMenu = () => {
  return (
    <div className="drop-down absolute text-GrayHomz font-[500] top-12 right-0 border h-[250px] w-[244px] z-10 rounded-md bg-white flex flex-col items-center justify-around">
