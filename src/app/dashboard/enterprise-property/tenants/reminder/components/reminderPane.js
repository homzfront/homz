        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center border-b md:gap-[120px] pt-2 pb-[24px]">
          ...
          <div className="">
            <input
              ...
              className="w-full md:w-[236px] h-[45px] text-BlackHomz border px-2"
      ...
      <div className=" mt-5 flex w-full flex-col md:flex-row justify-center gap-[24px] px-2 md:px-0 md:justify-end md:items-center md:gap-3">
        ...
        >
          <p className="flex gap-1">
            ...
            <span className="text-[16px] font-[400] text-BlackHomz">Preview reminder</span>
          </p>
        </button>
        <button
          className={`w-full
                    md:w-[120px] text-[16px] font-[700] h-[48px] ${isSaveButtonDisabled() ? " bg-GrayHomz6 text-GrayHomz5" : 'bg-BlueHomz text-white'} rounded-[4px] md:mr-[3rem] text-center  relative order-1 md:order-2`}
          onClick={openModal}
          disabled={isSaveButtonDisabled()} 
        >
          Save settings
