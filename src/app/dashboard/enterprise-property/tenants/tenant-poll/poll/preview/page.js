...
const Preview = ({backBtn}) => {
  ...
  return (
    <div className="pt-11 md:pt-4 px-8">
      <div className="hidden md:flex flex-col gap-6  pb-2">
        <Link href="/dashboard/enterprise-property/tenants/tenant-poll/poll/update-poll"
      ...
      <div className="inline-flex items-center md:hidden space-x-20 md:space-x-0  mb-9 md:mb-0 w-full">
        <Link
          href="/dashboard/enterprise-property/Poll"
      ...
      <div className=" w-[335px] md:w-full  py-[24px] px-[32px] gap-[32px] md:px-[24px] flex flex-col md:gap-[48px] rounded-[12px] bg-[#060505]">
        <div className="">
            ...
            <div className="">
              <div className="md:hidden flex flex-col">
                ...
                <div>
                  <input
                    type="text"
                    className="w-full md:w-[525px]  h-[45px] text-BlackHomz border p-[12px] rounded-[4px]"
                    value={pollQuestion}
                    id="pollQuestion"
                    name="pollQuestion"
              ...
              <div className=" w-[323px] flex items-center  md:w-[525px] h-[45px] gap-[14px] mt-3">
                ...
                /> */}
                <div className="w-full  flex items-center md:w-[493px] h-[45px] border rounded-[4px] px-2">
                  <input
                    type="text"
                    id="option1Qestion"
                    name="option1Qestion"
      ...
      <CustomizeModal isOpen={saveModalIsOpen} onRequestClose={closeModal}>
        <div className="bg-white border w-[333px] flex flex-col md:w-[464px] py-[24px] px-[16px] md:p-[32px] rounded-[12px] gap-[18px] items-center justify-center">
          ...
          <div className="flex  md:flex-col gap-2">
            <button
              className="bg-BlueHomz2 w-[137.5px]  text-white rounded-[4px] border  md:w-[400px] h-[48px] p-[12px]"
              onClick={handleSaved}
            >
              Yes
            </button>
            <button
              className="border-BlueHomz w-[137.5px]  text-blue-600 rounded-[4px] border  md:w-[400px] h-[48px] p-[12px]"
              onClick={() => {
                setSaveModalIsOpen(false);
              }}
            >
