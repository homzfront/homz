...
import CustomizeModal from "@/mainmenu/CustomizedModal";
        ...
        {PollVotes.map((pollVotes, index) => (
          ...
          >
            <div className="flex flex-col gap-2 md:pb-2">
              <label htmlFor={pollVotes.poll_title}>
                {pollVotes.poll_title}
              </label>
              <progress
                id="option1"
                value={pollVotes.votes.length * 10}
                max="100"
                className="w-[335px] md:w-[493px]"
              />
            </div>
            ...
            <button
              className="text-[14px] text-[500] leading-[16.5px] text-[#006AFF] ml-4 pt-2"
                    ...
                    <tr key={index} className="border-b py-0 px-[8px] h-[64px]">
                      <td className=" w-[142.5px]  py-[14px] px-[16px] h-[48px] md:py-[12px] md:px-[18px] text-left text-[12px] text-[#101828]-500">
                       ...
                       <Image
                        ...
                        />
                        <span className="pb-1 hidden md:block text-[#101828]">{vote.voter_name}</span>
                        <span className="pb-1 md:hidden underline underline-offset-4 text-[#101828]">{vote.voter_name}</span>
                       </div> 
                      </td>
