...
const PollQuestionResponse = () => {
  ...
  return (
    <div className="pt-5 md:pt-4 px-8">
      ...
      <div className="inline-flex items-center md:hidden space-x-20 md:space-x-0   md:mb-0 w-full">
        <Link
          href="/dashboard/enterprise-property/tenants/tenant-poll/poll/update-poll"
      ...
      <nav className="flex justify-between my-5 pl-1  md:pr-0 ">
        <div className="flex gap-3">
          <button
            className={`items-center md:w-[119px]  text-[14px] font-[500] flex justify-center ${
              questions ? "bg-[#006AFF] text-white"
                  : "text-[#4E4E4E] bg-[#EEF5FF] md:bg-inherit"
            } px-[12px] rounded-[4px] cursor-pointer gap-[8px]`}
          ...
          <button
            className={`items-center text-[12px] px-2 md:text-[14px] font-[500] flex rounded-[4px] text-[#4E4E4E] md:px-[12px] cursor-pointer gap-[8px] ${
          ...
          >
            ...
            <span
              ...
              } w-[27px] h-[21px] flex justify-center items-center py-[1.5px] rounded-[16px]`}
            >
              {totalVotes}
            </span>
          </button>
        ...
        <Link
          href="/dashboard/enterprise-property/tenants/tenant-poll/poll/update-poll"
          className="border border-blue-600 flex gap-1 items-center py-[8px] px-[12px] rounded-[4px]"
