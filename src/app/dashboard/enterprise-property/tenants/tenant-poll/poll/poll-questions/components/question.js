    ...
    <div className="">
      <div className=" w-full md:w-full  py-[24px] px-[28px] gap-[32px] md:px-[40px] flex flex-col md:gap-[48px] rounded-[12px] bg-[#060505]">
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-center gap-2">
          <p className="text-[14px] text-[400] leading-[21px] order-2 md:order-1 text-[#A9A9A9] md:mt-2 md:w-[550px] w-[271px]">
          ...
          <div className="flex gap-5 mt-5 pb-3">
            <div className="">
              ...
              <div className=" w-[323px] flex items-center  md:w-[525px] h-[45px] gap-[14px] mt-3">
                ...
                <div className="w-full  flex items-center md:w-[493px] h-[45px] rounded-[4px] px-2">
                  <input
                    type="text"
                    id="option1Qestion"
                    name="option1Qestion"
                    className="w-full md:w-[490px] h-[42px] border pl-4 rounded-[4px]"
