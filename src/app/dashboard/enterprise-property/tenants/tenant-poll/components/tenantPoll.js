      ...
      <>
        ...
        <div className="flex flex-col   w-[376px] md:w-full">
          <div className="flex flex-col md:items-center md:justify-center md:h-[412px] space-y-6">
            ...
            />
            <p className="text-[23px] md:text-[36px] font-[700] leading-[28.98px] md:leading-[45px] text-[#006AFF] mx-auto">
              Get Started
            </p>
            ...
            <Link href="/dashboard/enterprise-property/tenants/tenant-poll/poll" className="w-[338px] md:w-[122px] h-[48px] md:p-[12px] text-center rounded-[4px] text-white text-[16px] font-[700] bg-[#006AFF]">Create a poll</Link>
          </div>
        </div>
      </>
    </div>
