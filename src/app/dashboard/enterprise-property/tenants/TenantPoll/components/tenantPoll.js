      ...
      <>
        ...
        <div className="flex flex-col   w-[376px] md:w-full">
          <div className="flex flex-col md:items-center md:justify-center md:h-[412px] space-y-6">
            ...
            <Link href="/dashboard/enterprise-property/Poll" className="w-[338px] md:w-[122px] h-[48px] md:p-[12px] text-center rounded-[4px] text-white bg-[#006AFF]">Create Poll</Link>
          </div>
        </div>
      </>
    </div>
