      ...
      <div className="flex flex-col gap-[2rem] mt-3">
        <div className="flex flex-col justify-between gap-[28px]">
          <div className="hidden md:flex gap-2 items-center justify-between">
            ...
            <div>
              <Link className="adminBord items-center py-[8px] text-[14px] font-[500] flex bg-[#006AFF] text-white px-[10px] p-1 rounded cursor-pointer gap-2 mt-2" href="/dashboard/enterprise-property/Poll" >
                <span>
                  <Image
                    src={
