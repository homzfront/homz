...
const DropDownBlue = ({ options, onSelect, className, width = "w-[240px]", placeholder = "Download document as...", show = "false" }) => {
    ...
    return (
        <div className={`relative inline-block w-full ${className}`} ref={dropdownRef}>
            ...
            {isOpen && (
                <div className={`absolute z-20 top-[54px] font-[500] text-BlackHomz text-[14px] bg-white rounded-md shadow-md max-h-[240px] overflow-y-auto scrollbar-container ${width}`}>
