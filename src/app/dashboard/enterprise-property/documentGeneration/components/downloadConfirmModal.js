    ...
    return (
        <div className="px-8 md:px-0 absolute top-0 z-20 h-screen w-full  inset-0 flex items-center justify-center bg-black bg-opacity-30">
            <div className="md:max-w-[464px] m-auto bg-white h-auto rounded-md">
                <div onClick={returnHome} className="w-full flex justify-end p-4 cursor-pointer">
                    <div className="p-1 border border-BlackHomz rounded-[8px]">
                        <Close />
                    </div>
                </div>
                <div className="mt-[-40px] md:w-[464px] flex flex-col justify-around p-8 items-center gap-3">
                    <Image
                        src={
                    ...
                    <div className="flex gap-2 items-center w-full">
                        <button
                            onClick={returnHome}
                            className="hover:bg-BlueHomz2 px-4 h-[48px] rounded-md w-full bg-BlueHomz text-white text-[14px] font-[500] flex items-center justify-center gap-1"
                        >
                            <Flask />
                            {button}
                        </button>
                        <button
                            ...
                            className="hover:bg-whiteblue px-4 h-[48px] rounded-md w-full text-BlueHomz border border-BlueHomz text-[14px] font-[500] flex items-center justify-center gap-1"
                        >
                            <AddBlueSmall />
                            {buttonTwo}
                        </button>
