...
function PopUpMenu({ handleDeleteSingle, data, setOpenDetails }) {
    ...
    return (
        <div>
            ...
            <div
                // ref={dropdownRef}
                className="drop-down absolute top-9 md:top-11 z-100 w-[150px] md:w-[180px] text-GrayHomz font-[500] text-[13px] right-[30px] md:right-[67px] border py-2 rounded-md bg-white flex flex-col items-center justify-around"
            >
