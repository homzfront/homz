                    ...
                    <div className="w-[300px] sm:w-[373px] h-[458px] bg-white rounded-lg shadow-md mx-auto">
                      ...
                      <div className="flex flex-col px-6 py-4 justify-between h-[206px]">
                        <div className="flex justify-between items-center">
                          <Link
                            href={`/user_homepage/PreviewProperty/${property?.property?.slug}`}
                            className="text-BlueHomz text-[23px] font-[700]"
                          >
                          ...
                          {property?.property?.listingType && (
                            <Link
                              href={`/user_homepage/PreviewProperty/${property?.property?.slug}`}
                              className="bg-BlueHomz rounded-[4px] flex justify-center items-center w-[68px] h-[25px] text-white text-[11px] font-[400]"
                            >
                              {capitalizeFirstLetter(
                                property?.property?.listingType
                              )}
