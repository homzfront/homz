    ...
    <div className="flex gap-2 w-full">
      {Object.keys(dropdowns).map((dropdown) => (
        <div key={dropdown} className="relative">
          <div
            className={`${width ? `${width} md:w-[139px]` : 'w-[117px] md:w-[145px]'} bg-white h-[37px] md:h-[44px] text-[#A9A9A9]  adminCellBorders md:mb-1 md:pt-3 px-2 pt-2   rounded cursor-pointer ${
