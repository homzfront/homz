...
const PropertiesTable = ({ Data }) => {
  ...
  const handleRowClick = (Property) => {
    ...
    // router.push(`/admin_dashboard/Property/${Property.id}`);
            ...
            <div className={`${property && "hidden"}`}>
              ...
              <div className="mt-6">
                <table className="border w-full">
                  <thead className="bg-blue-50 text-[13px] font-[500] text-BlackHomz w-full text-center md:text-left h-[50px] ">
                    <tr>
                          ...
                          {/* ) : (
                            <div className="confirmation-dialog">
                              ...
                              <button
                                ...
                                className="profileIcons  w-[36px] h-[36px] p-[0px] rounded-[20px] text-[13px] cursor-pointer mr-[10px] text-BlueHomz"
                              >
                                Yes
                              </button>
                              <button
                                onClick={() => setShowConfirmation(false)}
                                className="profileIcons  w-[36px] h-[36px] p-[0px] rounded-[20px] text-[13px] cursor-pointer text-red-600"
                              >
                                No
                              </button>
                            </div>
