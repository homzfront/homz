...
const FAQs = () => {
    ...
    return (
        <div className="mt-[160px] max-w-[1160px] w-full m-auto mb-[60px] bg-whiteblue rounded-[12px] p-8">
            ...
            <div className="mt-[60px]">
                <div className="h-[210px] text-white flex justify-between bg-BlueHomz px-8 py-4 rounded-[16px] ">
                    ...
                    <div className="flex flex-col justify-center items-center h-[210px] gap-2 max-w-[1159px]">
                        <h1 className="text-[20px] font-[600]">Ready to Simplify Your Property Management?</h1>
