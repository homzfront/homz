        ...
        <div className="w-full h-[320px] m-auto">
          <div className="max-w-[1156px] m-auto">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="max-w-[552px] mx-5 bg-[#F6F6F6] rounded-[12px] p-[20px]">
              ...
              <form className="flex flex-col gap-6  sm:pr-6 sm:pl-5 bg-[#F6F6F6] rounded-[12px] p-[20px] ">
