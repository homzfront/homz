  ...
  const handleBusinessCertificate = (e) => {
    ...
    if (file) {
      if (file.size > MAX_FILE_SIZE) {
        ...
        }, 20); // Update progress every second
        setUploadIntervalID(uploadInterval);
      }
    }
  };
  const closeModal = () => {
        ...
        <div className="w-full ">
            ...
            <div className="flex flex-col md:flex-row justify-between md:gap-0 gap-6 sideBarHidden">
             <div className="md:w-[564px] fields miniMargin md:mx-5 md:bg-[#F6F6F6] md:rounded-[12px] p-[20px] headerAdmin md:border-0">
                <div className="flex justify-between flex-col gap-8 headerAdmin pb-8">
                  <div className="flex flex-col gap-2 ">
                    ...
                    <input
                      ...
                      value={businessName}
                      className="proBorders md:px-4 h-[45px] w-full rounded-md placeholder:text-[14px]"
                ...
                <div className="md:w-full  flex flex-col gap-[14px] pt-5">
                    ...
                    {!businessCertificateUpload ? (
                      <div className="flex flex-col gap-[4px]">
                        ...
                        <p className="text-[13px] md:text-[14px] font-[500] leading-[19.5px] md:leading-[21px] text-left ">
                          ...
                          >
                            Click to upload CAC or membership certificate
                          </span>{" "}
                      ...
                      <div className="flex flex-col gap-[8px] w-full">
                        <div className="flex items-center justify-between">
                          <p className="text-[13px] md:text-[14px] font-[500] leading-[19.5px] md:leading-[21px] text-left ">
                            ...
                            <span className="text-[#006AFF] inline-block cursor-pointer">
                              [
