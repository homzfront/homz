...
const ShortletByLocationAndType = ({ params }) => {
  ...
  // Custom reset for dynamic pages - redirect to base shortlet page
  const reset = () => {
  ...
  useEffect(() => {
    const urlFilters = parseUrlToFilters(params, 'shortlet');
...
export default ShortletByLocationAndType;