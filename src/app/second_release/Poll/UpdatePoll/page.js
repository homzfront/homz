  ...
  return (
    <div className="pt-11 md:pt-0 ">
      <div className="hidden md:flex flex-col gap-6  pb-1">
        <Link href="/second_release/Poll/PollQuestions">
        ...
        <p className=" md:text-[20px] text-[700]">Update Poll</p>
      </div>
      <div className="flex items-center md:hidden space-x-20  mb-9 md:mb-0">
        <Link
          href="/second_release/Poll/PollQuestions"
      ...
      <div className="w-full mt-2 py-[24px] px-[32px]  bg-[#F6F6F6] md:px-6 space-y-1">
        ...
        <div className="">
          ...
          <div className="flex gap-5 ">
            <div className="">
              ...
              />
              <div className=" w-[323px] flex items-center  md:w-[515px] h-[45px] gap-[2px] mt-3">
