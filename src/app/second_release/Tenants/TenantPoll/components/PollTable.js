      ...
      <div className="flex flex-col gap-[2rem] mt-3">
        <div className="flex flex-col justify-between gap-[28px]">
          <div className="hidden md:flex gap-2 items-center justify-between">
            ...
            <div>
              <Link className="adminBord items-center py-[8px] text-[14px] font-[500] flex bg-[#006AFF] text-white px-[10px] p-1 rounded cursor-pointer gap-2 mt-2" href="/admin_dashboard/Poll" >
                <span>
                  <Image
                    src={
          ...
          <div className="flex gap-3">
            <button
              className={`adminBord items-center w-[119px] h-[37px] text-[14px] font-[500] flex ${
                ongoing
            ...
            >
              Ongoing
              <span
                className={`w-[27px] h-[21px] text-center  rounded-[16px] ${
                  ongoing
          ...
          <div className="flex items-center gap-2"> */}
            ...
            <button
              className={`items-center text-[14px] font-[500] flex rounded-[4px]  px-[12px] py-[8px] cursor-pointer gap-[8px] ${
                closed
                  ? "bg-[#006AFF] text-white"
                  : "text-[#4E4E4E] bg-[#EEF5FF] md:bg-inherit"
              }`}
            ...
            <tbody className="">
              {currentData.map((data, index) => (
                <tr key={index} className="pl-3">
                  ...
                  >
                    <Link
                      href="/admin_dashboard/Poll/PollQuestions"
