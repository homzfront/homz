        ...
        <div className="profiles flex flex-col space-y-7">
          ...
          <div className="w-[320px] space-y-1">
            ...
            <UserRole
              ...
              isOpen={openUserRoleDropdowns[12] || false}
              toggleDropdown={() => toggleUserRoleDropdown(12)}
              bg_color={edit}
            />
          </div>
        </div>
        <div className="profiles flex flex-col space-y-7">
          ...
          <div className="space-y-1 w-[320px] ">
            ...
            <Access
              ...
              isOpen={openAccessDropdowns[12] || false}
              toggleDropdown={() => toggleAccessDropdown(12)}
              editable={edit}
            />
          </div>
        </div>
