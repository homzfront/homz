  ...
  return (
    <div className="m-auto max-w-[1024px] p-8">
      <div className="m-auto w-[600px] h-[864px] shadow-lg p-6 flex flex-col">
        ...
        <p className="text-[10px] font-[400] text-BlackHomz mt-3 text-justify">
          ...
          suspendisse viverra porta.
        </p>
        <div className="flex justify-between my-14">
          <div className="flex flex-col gap-2">
            <p className="border-t w-[168px]"></p>
            <p className="text-[10px] font-[400] text-BlackHomz text-center">
              Vitae mi venenatis
            </p>
          </div>
          <div className="flex flex-col gap-2">
        ...
        <div className="bg-BlueHomz rounded-md h-[36px] w-full flex items-center justify-between px-4">
