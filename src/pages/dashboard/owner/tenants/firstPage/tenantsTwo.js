...
const TenantsTwo = ({ Data }) => {
  ...
  return (
    <div className="mt-6 w-[375px] md:w-full">
      <div className=" border  w-[375px] md:w-full rounded-t-[12px]">
        <div className="bg-whiteblue w-full h-[60px] text-[13px] flex items-center pl-3 md:pl-0 gap-[12rem] md:justify-center md:gap-2 font-[500] text-BlackHomz  md:px-4 rounded-t-[12px]">
          <div className="w-[15%] ">Tenant</div>
          <div className="w-[10%] hidden md:block">Property</div>
          <div className="w-[11%] hidden md:block">Apartment No</div>
          <div className="w-[11%] hidden md:block">Address</div>
          <div className="w-[10%] hidden md:block">Email</div>
          <div className="w-[10%] pl-1 hidden md:block">Phone No</div>
          <div className="w-[7%] pl-1 hidden md:block">Rent</div>
          <div className="w-[13%] pl-1">Status</div>
          <div className="w-[10%] hidden md:block">Due Date</div>
          <div className="w-[3%] hidden md:block"></div>
        </div>

        <div className=" w-[375px] pl-1 md:w-full">
          {currentData &&
            currentData.map((data) => (
              <div
                key={data.id}
                className="border-b-[1px] items-center pl-[0px] flex w-[375px] gap-[12rem] md:justify-center md:w-full md:gap-2 md:px-4 h-[60px]"
              >
                ...
                <div className="text-GrayHomz w-[10%] font-[500] text-[11px] text-start hidden md:block">
                  {data.Estate}
                </div>
                <div className="text-GrayHomz w-[11%] font-[500] text-[11px] text-start hidden md:block">
                  {data.ApartmentNo}
                </div>
                <div className="text-GrayHomz w-[11%] font-[500] text-[11px] text-start hidden md:block">
                  {data.Address}
                </div>
                <div className="text-GrayHomz w-[10%] font-[500] text-[11px] text-start pl-1 pr-2 hidden md:block">
                  <span className="break-words">{data.Email}</span>
                </div>
                <div className="text-GrayHomz w-[10%] font-[500] text-[11px] text-start  hidden md:block">
                  {data.PhoneNo}
                </div>
                <div className="text-GrayHomz w-[7%] font-[500] text-[11px] text-start  hidden md:block">
                  {data.Rent}
                </div>
                <div
                ...
                <div className="relative w-[3%] hidden md:block">
