        ...
        <div ref={printableRef} className=''>
            ...
            <div className='page-break h-screen px-[48px] py-[70px] bg-white flex justify-center items-center'>
                <div className='h-[90%] bg-white flex flex-col text-[16px] font-[400] text-BlackHomz text-justify justify-between'>
                    ...
                    <p>2.1	In consideration for the grant by the <span className='font-[600]'>Landlord</span>, of a tenancy in respect of the <span className='font-[600]'>Demised Premises</span> for the term reserved herein, the <span className='font-[600]'>tenant</span> shall pay to the <span className='font-[600]'>Landlord</span>, upon execution of this agreement the sum of <span className='font-[600] text-BlueHomz'>{formData?.rentPaymentInWords ? formData?.rentPaymentInWords : ""}, ({formData?.selectedCurrency ? extractCurrencySymbol(formData?.selectedCurrency) : ""} {formData?.rentPayment ? addCommasToNumberWithoutN(formData?.rentPayment) : ""})</span> per annum (g) net of all taxes, levies, all fully paid in advance, the receipt whereof the Landlord hereby acknowledges.</p>
