...
const WithoutRentInfo = ({ setUnimportedTenantRentModal }) => {
    ...
    return (
        <div className='w-full lg:w-[700px]'>
            <div className='flex justify-between items-start'>
                <div className='w-[75%] flex flex-col gap-2'>
                    <h1 className='text-BlackHomz font-[500px] text-[16px] lg:text-[18px]'>
                        Rent information is incomplete/unmapped
                    </h1>
                    <h3 className='text-GrayHomz font-[400px] text-[12px] lg:text-[14px]'>
                        These tenants will be imported without rent details unless all rent fields are filled and mapped.
                    </h3>
            ...
            <p className='p-1 bg-[#EEF5FF] text-[#4E4E4E] w-full text-start mt-2 font-medium text-[14px] lg:text-[16px]'>
                <span className='font-normal'>Rent fields include: </span> Property type, Apartment No, Rent Duration, Start Date and Due Date
            </p>
...
export default WithoutRentInfo