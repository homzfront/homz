...
const DataMapping = ({ handlePageChange, setImportData }) => {
                ...
                <div className="overflow-y-auto scrollbar-containerII max-h-[calc(100vh-60vh)] lg:max-h-[calc(100vh-50vh)]">
                    {data &&
                        data.map((data, index) => (
                            <div
                                key={index}
                                className={`border-b-[1px] items-center flex justify-center w-full gap-2 p-2`}
                            >
                                <div
                                ...
                                >
                                    {data?.data.map((data, index) => (
                                        <div className="text-GrayHomz font-[500] mt-1 text-[13px] text-start" key={index}>{data}</div>
                                    ))}
                                </div>
                                <div
            ...
            <div className="overflow-y-auto scrollbar-containerII max-h-[calc(100vh-60vh)] lg:max-h-[calc(100vh-50vh)] mt-2">
                {data &&
                    data.map((data, index) => (
                        <div
                            key={index}
                            className={`lg:hidden items-center flex flex-col justify-center w-full gap-2 pb-2 bg-[#F6F6F6] mb-2`}
                        >
                            <div
