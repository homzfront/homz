...
const AcceptAndRejectModel = ({
  ...
  return (
    <div>
      <div className="px-8 md:px-0 absolute top-0 z-20 h-screen inset-0 flex items-center justify-center bg-black bg-opacity-30">
        <div className="md:max-w-[464px] pt-4 pb-6 m-auto bg-white md:h-[240px] rounded-md">
          <div className="md:w-[464px]flex flex-col justify-around items-center gap-4 px-8">
