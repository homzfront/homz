...
const TrialWarning = ({ closeMenu, user }) => {
    return (
        <div>
            <div className="absolute right-[45px] md:right-[110px] top-[54px] md:top-[70px] w-[320px] md:w-[400px] h-[125px] bg-warningBg border border-warning2 rounded-[12px] shadow-md px-4 py-2 z-20">
