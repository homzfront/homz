  ...
  return (
    ...
    className="dropdown w-full">
      {loading ? (
        ...
        <div>
          <button
         className={` relative rounded-md py-1 w-[95px] flex items-center justify-center ${
          ...
          <ul
            className={`dropdown-menu absolute top-[17px] left-0 z-50 mt-2 w-[95px] h-[80px] flex flex-col items-start justify-around px-2 py-1 bg-white shadow-md rounded-md ring-1 ring-black ring-opacity-5 focus:outline-none ${
              isOpen ? "block" : "hidden"
            }`}
          >
            <li>
