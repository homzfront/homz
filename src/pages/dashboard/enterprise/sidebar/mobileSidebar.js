...
import useProfileStore from "/src/store/profile";
 ...
 const MobileSidebar=()=>{
    ...
    return     <div className={!close ? "mobilesidebar" :"hidden"}>
    <div className="shadow-lg">
      <div className="w-full h-[789px] px-[2.5rem] flex flex-col justify-around md:h-[820px] ">
        <div className=" flex justify-between items-center">
          ...
          <button className="md:hidden" onClick={closeBar}>
            <svg
