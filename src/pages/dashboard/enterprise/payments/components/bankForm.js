...
import { addBankPropertyEnterprise } from "@/api/enterpriseManagerService";
import Loading from "@/components/mainmenu/loading";
import LoadingForm from "@/components/mainmenu/loadingForm";
import BankSelect from "./selectBank.js";


const BankForm = ({ closeMenu, Banks, fetchDataAgain }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { success, upDateddata, error } = await addBankPropertyEnterprise(
        bankDetails
      );
      if (success) {
