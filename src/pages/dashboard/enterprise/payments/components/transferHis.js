...
const TransferHis = () => {
  ...
  return (
    <div className="p-5 border rounded-[12px] mt-8">
            ...
            <div>
              {data.Status === "Receive" ? (
                <div className="flex items-center justify-between mt-6 border-b h-[40px] pb-5">
                  ...
                  <p className="text-[10px] font-[500] text-GrayHomz w-[220px]">Received {data.Amount} from {data.From}</p>
                  <span className="text-[10px] font-[400] text-GrayHomz2">{data.TransDate}</span>
                  </div>
                  <div className="text-[10px] font-[400] text-Success w-[60px]">
                    {data.Amount}
                  </div>
                </div>
              ) : (
                ...
                <div className="flex flex-col gap-[-5px]">
                <p className="text-[10px] font-[500] text-GrayHomz w-[220px] ">You sent {data.Amount} to {data.From}</p>
                <span className="text-[10px] font-[400] text-GrayHomz2">{data.TransDate}</span>
                </div>
                <div className="text-[10px] font-[400] text-error w-[60px]">
                  {data.Amount}
                </div>
              </div>
              )}
