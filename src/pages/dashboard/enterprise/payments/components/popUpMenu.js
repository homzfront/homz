...
const PopUpMenu = ({ data, setPopUpMenu }) => {
    return (
        <div className='w-[350px] md:w-[470px] h-auto bg-white rounded-[12px] p-6'>
            ...
            <div className='mt-3 w-full bg-inputBg py-4 px-6 rounded-[8px]'>
                <div className='w-full'>
                    <div className='flex justify-between items-start w-full'>
                        <p className='text-BlackHomz font-[400] text-[14px] w-[45%]'>
                            Property
                        </p>
                        <p className='text-GrayHomz font-[400] text-[14px] w-[45%]'>
                            {data?.estateName}
                        </p>
                    </div>
                </div>
