    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            if (response?.data?.success) {
                successfullModal();
                setOfflinepay(false);
                fetchData(id, data.startDate, data.dueDate);
                setRefetch(true);
                reFetchData();
                exportFetch(id);
            }
                ...
                <form onSubmit={onSubmit} className={`space-y-4 mt-3 ${isLoadingForm ? "pointer-events-none" : ""}`}>
                    ...
                    <div className="bg-inputBg py-4 px-6 rounded-[8px] flex items-center justify-between">
                        ...
                        {errors.dateOfTransaction && (
                            <span className="text-red-500 text-xs mt-1">{errors.dateOfTransaction}</span>
                        )}
                    </div>
                    ...
                    <div className="bg-inputBg rounded-[8px]">
                        ...
                        <div className="py-4 px-6 flex items-center justify-between">
                            ...
                            {errors.startDate && (
                                <span className="text-red-500 text-xs mt-1">{errors.startDate}</span>
                            )}
                        </div>
                        ...
                        <div className="pointer-events-none py-4 px-6 flex items-center justify-between">
                            ...
                            {errors.dueDate && (
                                <span className="text-red-500 text-xs mt-1">{errors.dueDate}</span>
                            )}
                        </div>
                    </div>
                    {errors.backend && (
                             <span className="text-red-500 text-xs mt-1">{errors.backend?.[0]}</span>
                            )}
