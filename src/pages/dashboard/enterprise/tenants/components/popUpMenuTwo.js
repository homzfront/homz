...
function PopUpMenuTwo({ data, handleDelete,dropdownRef }) {
  ...
  console.log(data);
    return (
      <div ref={dropdownRef} className="drop-down absolute top-7  text-GrayHomz font-[500] text-[13px] right-[26px] border   rounded-md bg-white flex flex-col items-center justify-around">
