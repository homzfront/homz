...
function PopUpMenuTwo({ data, handleDelete }) {
  ...
  console.log(data);
    return (
      <div className="drop-down absolute top-7  text-GrayHomz font-[500] text-[13px] right-[26px] border   rounded-md bg-white flex flex-col items-center justify-around">
