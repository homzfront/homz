...
const ConfirmModalI = ({
  ...
  return (
    <div>
      <div className="fixed inset-0 flex items-center px-8 md:px-0 justify-center z-20 bg-black bg-opacity-30">
        <div className="w-full md:max-w-[464px] p-2 m-auto bg-white h-[280px] rounded-md">
