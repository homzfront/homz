...
const StatusDropdown = ({
  ...
  return (
    <div className="dropdown">
      ...
      <ul
        className={`dropdown-menu absolute m-auto   w-[100px] h-[80px] flex flex-col items-start justify-around px-2 mt-1 py-1 bg-white shadow-md rounded-md ring-1 ring-black ring-opacity-5 focus:outline-none ${
          isOpen ? "block" : "hidden"
        }`}
      >
        <li>
