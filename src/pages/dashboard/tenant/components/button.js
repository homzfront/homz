  ...
  return (
    <div className="flex gap-2 justify-between items-center mt-4">
      <div>
        <button
          onClick={handlePrev}
          className={`text-[14px] font-[500] py-2 px-6 border rounded-md hover:bg-whiteblue border-GrayHomz sm:border-BlueHomz text-BlueHomz flex items-center justify-center${currentPage === 1 ? "pointer-events-none opacity-20" : ""
            }`}
        >
          <Image
      ...
      <div>
        <button
          onClick={handleNext}
          className={`py-2 px-6 rounded-md text-[14px] font-[500] border hover:bg-whiteblue border-GrayHomz sm:border-BlueHomz text-BlueHomz flex items-center justify-center ${totalPages <= 6 ? "ml-[0]" : "ml-0"
