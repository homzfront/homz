...
const Receipt = ({ closeReceipt, shareReceipt }) => {
  return (
    <div className="absolute top-0 z-20 h-screen w-full inset-0 flex items-center justify-center shadow-lg bg-black bg-opacity-30">
      <div className="h-[660px] w-[530px] bg-white rounded-lg px-8 pt-6">
        <div className="flex flex-col gap-3">
          ...
          <button onClick={shareReceipt} className="w-full h-[48px] bg-BlueHomz rounded-md text-white">
            Share Receipt
          </button>
        ...
        <p className="text-[11px] font-[400] text-GrayHomz text-center">
