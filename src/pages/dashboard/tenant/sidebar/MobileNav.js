...
const MobileNav= ({closeSideNav}) => {
  ...
  return (
<div className={close ?"mobileNav md:block": 'hidden'}>
      <div className="shadow-lg">
        <div className=" flex  px-6 justify-between items-center pt-3">
        <div>
          <Link href={"/"}>
            <Image
        ...
        <button className="md:hidden bg-stone-300 rounded-md p-1" onClick={closeSideNav}>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
        ...
        <div className="w-full h-[850px] pt-[2rem] px-6 flex flex-col gap-[1.5rem]">
