  ...
  return (
    <div className='flex mt-[40px] py-8 max-w-[1160px] m-auto px-6 justify-between'>
      ...
      <div className="hidden md:flex p-4 gap-4">
        <Link href={""} className="  w-[109px] h-[48px] text-[16px] hover:w-[146px] flex items-center justify-center hover:h-[54px] rounded-md font-normal  bg-BlueHomz  text-white  px-2 py-1 hover:text-[18px] ">
        Book Demo
        </Link>
