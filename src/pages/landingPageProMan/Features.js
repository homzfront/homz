...
const Features = ({ routeTo, profile }) => {
  ...
  const cards = [
    {
      icon: <PeopleWhite />,
      title: "Manage All Your Renters in One Central Platform",
      description:
        "Effortlessly streamline your operations by managing all renters in one centralized platform.",
    },
    {
      icon: <MoneySend />,
      title: "Incentivize Timely Rent Payments",
      description:
    ...
    {
      icon: <MessagesWhite />,
      title: "Comprehensive Property Management Features",
      description:
      ...
      <div className="">
        <div className="flex flex-col justify-around items-center p-8 bg-[url('/Background_image.png')] text-white rounded-lg shadow-2xl bg-cover bg-center bg-BlueHomz max-w-full xl:w-[1159px] h-[303px]">
          ...
          <div className="flex w-full sm:w-auto flex-col sm:flex-row gap-4">
            ...
            <Link href={"https://cal.com/homzng/"} className="w-full sm:w-[116px] h-[48px] text-[16px] hover:bg-white  flex items-center justify-center hover:text-BlueHomz rounded-md font-normal  text-white border bg-transparent px-2 py-1">
              Book Demo
            </Link>
          </div>
        </div>
