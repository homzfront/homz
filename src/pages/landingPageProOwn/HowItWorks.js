...
const HowItWorks = ({ routeTo, profile }) => {
  const settings = {
    dots: true,
    infinite: true,
    speed: 500,
  ...
  return (
    <div className="mt-[150px] max-w-[1160px] m-auto px-6 flex flex-col items-center">
      ...
      <div className="mt-16 flex flex-col justify-around items-center py-[60px] px-8 bg-[url('/Background_image.png')] text-white rounded-lg shadow-2xl bg-cover bg-center bg-black/90 max-w-full sm:w-[670px]  md:w-[786px] lg:w-[824px] xl:w-[1159px] h-[303px]">
