...
const SideNav = () => {
  return (
    <div className="md:w-60 SideNav bg-white h-screen flex-1 fixed border-r border-zinc-200 hidden md:flex md:pt-4">
      ...
      {item.submenu ? (
        ...
        <Link
          ...
          className={`flex flex-row space-x-4 items-center p-2 rounded-lg ${
            item.path === "/second_release/user" ? "bg-BlueHomz text-white" : "hover:bg-blue-100"
          }`}
        >
          {/* {item.icon} */}
          {item.path ==="/second_release/user" 
